...
namespace Hospital_Managment_System.User_Control
{
    ...
    public partial class UserControlSetting : UserControl
    {
        ...
        private void tabPageSearchUse_Leave(object sender, EventArgs e)
        {
        ...
        private void tabPageSearchUser_Layout(object sender, LayoutEventArgs e)
        {
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            if (ID != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Are You Want To Dlete This User?", "User Delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
